                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="index.php">
                                <div class="mb-3">
                                    ...
                                    <select name="cantidad" id="cantidad" class="form-select form-select-sm" aria-label="Small select example">
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                    </select>
                                </div>
                                <button class="btn btn-primary" type="submit">Agregar el total</button>
                                <button class="btn btn-secondary" name="btnQuitar" type="submit">Quitar todo</button>
                            </form>
                        </div>
